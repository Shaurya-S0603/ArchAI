...
No neural training has been performed in this release. Phase 2C adds a 592-plan
synthetic training-interface pilot with grouped splits, normalization and masked
batches. It inherits the deterministic teacher's corridor/perimeter bias and is
not a real-plan corpus. See `docs/TRAINING_DATA_PIPELINE.md`.
